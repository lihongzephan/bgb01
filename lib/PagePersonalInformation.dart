...
class ClsPersonalInformation extends StatelessWidget {
  ...
  void funChangePressed(context) async {
    ...
    if (!gv.bolLoading) {
      ...
      if (ut.stringBytes(gv.ctlPerInfoUserNick.text) <
        ...
        gv.storePerInfo.dispatch(GVActions.Increment);
        return;
      }
      ...
      if (gv.ctlPerInfoUserNick.text == gv.strPerInfoUsr_NickL &&
          gv.ctlPerInfoUserEmail.text == gv.strPerInfoUsr_EmailL) {
        // Nothing Changed
  ...
  void funCancelPressed(context) async {
    await SystemChrome.setEnabledSystemUIOverlays([]);
    // Goto SettingsMain
    gv.gstrLastPage = gv.gstrCurPage;
    gv.gstrCurPage = 'SettingsMain';
  ...
  Widget Body(context) {
    gv.strPerInfoUserID = gv.strLoginID;
    gv.strPerInfoExpiry = gv.strPerInfoUsr_Expiry;
    gv.strPerInfoMinLeft = gv.intPerInfoUsr_VDMinLeft.toString();
    return Center(
      child: Container(
        color: Colors.white,
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    Text(ut.Space(sv.gintSpacePerInfoText)),
                    Text(ls.gs('UserID') + ': ',
                        style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: sv.dblDefaultFontSize * 0.9)),
                    Expanded(
                      child: Text(gv.strPerInfoUserID,
                          style: TextStyle(
                              fontSize: sv.dblDefaultFontSize * 0.9,
                    ...
                    Expanded(
                      child: SizedBox(
                        ...
                        child: RaisedButton(
                          ...
                          textColor: Colors.white,
                          color: Colors.greenAccent,
                          onPressed: () => funCancelPressed(context),
                          child: Text(ls.gs('Cancel'),
                              style: TextStyle(
                                  fontSize: sv.dblDefaultFontSize * 1)),
                        ),
                      ),
